<?php $this->layout('layouts/admin/app', ['title' => 'Yeni Kullanıcı Ekle']) ?>

<?php $this->start('body') ?>
<div class="md:grid md:grid-cols-3 md:gap-6">
    <div class="md:col-span-1">
        <div class="px-4 sm:px-0">
            <h3 class="text-lg font-medium leading-6 text-gray-900">Yeni Kullanıcı Ekle</h3>
                    ...
                    <div class="grid grid-cols-6 gap-6">
                        ...
                        <div class="col-span-6">
                            ...
                            <div class="mt-1 flex items-center">
                                <span id="image-preview" class="inline-block h-12 w-12 rounded-full overflow-hidden bg-gray-100">
                        ...
                        <div class="col-span-6">
                            ...
                            <div class="mt-1">
                                <textarea id="bio" name="bio" rows="3"
                                          class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md"><?= old('bio') ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
...
function previewImage(input) {
    ...
    if (input.files && input.files[0]) {
        ...
        reader.onload = function(e) {
            preview.innerHTML = '<img src="' + e.target.result + '" alt="Önizleme" class="h-full w-full object-cover">';
        }
